...
@implementation WattRegistryFile 
...
- (instancetype)wattCopyInRegistry:(WattRegistry*)destinationRegistry{
	WattRegistryFile *instance=[super wattCopyInRegistry:destinationRegistry];
...
- (instancetype)wattExtractAndCopyToRegistry:(WattRegistry*)destinationRegistry{
	WattRegistryFile *instance=[super wattExtractAndCopyToRegistry:destinationRegistry];
	instance->_registry=destinationRegistry;
	instance->_registryUidString=[_registryUidString copy];
	instance->_relativePath=[_relativePath copy];
    return instance;
...
- (NSMutableDictionary*)dictionaryOfPropertiesWithChildren:(BOOL)includeChildren{
	...
	if(_registryUidString){
		[dictionary setValue:self.registryUidString forKey:@"a"];
	}
	if(_relativePath){
		[dictionary setValue:self.relativePath forKey:@"b"];
	}
    return dictionary;
}
