...
+ (WTMCollectionOfLangDictionary*)instanceFromDictionary:(NSDictionary *)aDictionary{
	WTMCollectionOfLangDictionary* instance = [[WTMCollectionOfLangDictionary alloc] init];
...
- (void)setAttributesFromDictionary:(NSDictionary *)aDictionary{
    ...
    for (NSDictionary*objectDictionary in a) {
        WTMLangDictionary*o=[WTMLangDictionary instanceFromDictionary:objectDictionary];
