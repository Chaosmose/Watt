...
- (instancetype)wattCopyInRegistry:(WattRegistry*)registry{
    WTMCollectionOfActivity *instance=[super copy];
...
- (id)copyWithZone:(NSZone *)zone{
    WTMCollectionOfActivity*instance=[[[self class] allocWithZone:zone] init];
    instance->_registry=nil; // We want to furnish a registry free copy
    //_uinstID=0;// we do not provide an _uinstID
   WTMCollectionOfActivity*__block ref=instance;
    [self enumerateObjectsUsingBlock:^(WTMActivity *obj, NSUInteger idx, BOOL *stop) {
