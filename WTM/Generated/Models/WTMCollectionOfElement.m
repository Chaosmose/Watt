...
- (instancetype)wattCopyInRegistry:(WattRegistry*)registry{
    WTMCollectionOfElement *instance=[super copy];
...
- (id)copyWithZone:(NSZone *)zone{
    WTMCollectionOfElement*instance=[[[self class] allocWithZone:zone] init];
    instance->_registry=nil; // We want to furnish a registry free copy
    //_uinstID=0;// we do not provide an _uinstID
   WTMCollectionOfElement*__block ref=instance;
    [self enumerateObjectsUsingBlock:^(WTMElement *obj, NSUInteger idx, BOOL *stop) {
