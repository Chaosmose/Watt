...
- (instancetype)wattCopyInRegistry:(WattRegistry*)registry{
    WTMCollectionOfBehavior *instance=[super copy];
...
- (id)copyWithZone:(NSZone *)zone{
    WTMCollectionOfBehavior*instance=[[[self class] allocWithZone:zone] init];
    instance->_registry=nil; // We want to furnish a registry free copy
    //_uinstID=0;// we do not provide an _uinstID
   WTMCollectionOfBehavior*__block ref=instance;
    [self enumerateObjectsUsingBlock:^(WTMBehavior *obj, NSUInteger idx, BOOL *stop) {
