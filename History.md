...
==================
  ...
  * registriesUidStringList memory support
  * Tests and misc changes on object, registry and pool
  * Unit tests in progress
  * Registry pool instantiation method and file deletion clarification
  * NSObject+WattBase
  * Clarification of External referencing
  * Regisgtry utils relative folder path
  * WattRegistry pools
  * WTM Lazy dictionary representation
  * WattReference for cross registry referencing
  * Wtm packages caching by extension
  * WattObject hasChanged notifies to its holding registry
  * History update & version increment
  * Registry's container support
  * WTM pod import issue fix
  * Change log update
  * Re-packaging
  * Imports issues fix
  * Cleaning
