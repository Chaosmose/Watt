...
@interface WTMCollectionOfMenuSection:WattCollectionOfObject <WattCoding>{
}
- (void)enumerateObjectsUsingBlock:(void (^)(WTMMenuSection *obj, NSUInteger idx, BOOL *stop))block;
