...
+ (WTMCollectionOfUser*)instanceFromDictionary:(NSDictionary *)aDictionary{
	WTMCollectionOfUser*instance = nil;
	if([aDictionary objectForKey:@"className"] && [aDictionary objectForKey:@"properties"]){
		...
		instance=(WTMCollectionOfUser*)unCasted;
	}
	return instance;
}
...
- (void)setAttributesFromDictionary:(NSDictionary *)aDictionary{
    ...
    for (NSDictionary*objectDictionary in a) {
        WTMUser*o=[WTMUser instanceFromDictionary:objectDictionary];
